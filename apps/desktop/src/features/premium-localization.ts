...
const ENGLISH_COPY: Readonly<Record<string, string>> = Object.freeze({
  ...
  'Nenhuma alteração aplicada': 'No changes applied',
  ...
  Máximo: 'Maximum',
  Moderado: 'Moderate',
  'Monitoramento somente leitura': 'Read-only monitoring',
  Padrão: 'Standard',
  Quente: 'Hot',
  Sustentada: 'Sustained',
  Térmico: 'Thermal',
  'Dados locais do cenário demonstrativo': 'Local demonstration scenario data',
