      ...
      parserOptions: {
        projectService: {
          allowDefaultProject: [
            ...
            'apps/desktop/tests/browser/appearance-responsive.spec.ts',
            'apps/desktop/tests/browser/fixtures.ts',
            'apps/desktop/tests/browser/first-run-responsive.spec.ts',
            'apps/desktop/tests/browser/game-selector-theme.spec.ts',
            'apps/desktop/tests/browser/harness.config.pw.ts',
            'apps/desktop/tests/browser/initial-surfaces-responsive.spec.ts',
            ...
            'apps/desktop/tests/browser/account-profile.spec.ts',
