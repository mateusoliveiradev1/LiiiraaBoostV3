...
| `public-principles` · `/[locale]/principles`       | Understand the commitments behind every optimization · Evidence, stability, privacy, and reversibility | See how it works · Product               | public/local; independent from Our Story        |
...
| `public-essential-storage` · `/[locale]/policies/essential-storage`        | Understand storage required for safe site delivery · Essential storage only | Review privacy · Support                 | public/local          |
...
| `public-responsible-disclosure` · `/[locale]/responsible-disclosure`       | Prepare a coordinated security report · Report responsibly                  | Follow contact preflight · Security      | public/local          |
