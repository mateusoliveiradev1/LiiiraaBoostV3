...
| 06-31 | PLAN-01,05–08 | T-06-31A/B/C | Sole builder emits all three generated configs and a detached-CMS-signed artifact manifest; desktop/service/runner are installed while tauri-driver/msedgedriver remain mandatory portable-only roles; live lifecycle preserves recovery custody | Node installed-vs-portable-role/config mutation suite plus mandatory Windows `build-and-smoke` bytes/CMS/lifecycle command |
