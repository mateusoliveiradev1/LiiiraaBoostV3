...
## Append-Only v67 Bridge and Read-Only Audit Addendum

- Bridge RED `06f4e904` and GREEN `e8758208` bind only build `physical-7304c595be0d094e-managed-power-scheme-v67`, artifact manifest SHA-256 `e2689db3ef625a3ef4b1d1bd3f7ad22278a0dc868d0eaedebd053fb0fc55984f`, deterministic run SHA-256 `7e93a708b039cb5caaa8a4417ac6fe59189a274eb179afe75a3700995b481ce0`, and evidence manifest SHA-256 `bfa8ddc06bab183857e653b1f44b0106c0e4707bc7e74a3752e89277340f92f4`.
- The v66 installed checkpoint was archived rename-only as `LiiiraaBoost-Installed-BLOCKED-v66`, preserving GUID `775e131a-3485-45c1-85b1-9420b0cab47a`, VM `Off`, and checkpoint count 7→7. Durable evidence `C:\Users\Liiiraa\VM-Lab\Evidence\phase6\20260816-215741-590-managed-power-scheme-v66-checkpoint-archive.json` has SHA-256 `a9f65c61d13e06b0839f572498b29c30b3691a37d711ebbf79bc05a46aca5082`.
- Read-only Audit PASS: `C:\Users\Liiiraa\VM-Lab\Evidence\20260816-215822-phase6audit-console.log`, SHA-256 `81f6abb3740499b67e85fbb41f3345bb0e951b98ccea8d5ee30a877b268f7150`.
- Audit boundaries were `artifact-verifier-pass`, `simulation-admission-pass`, `hyper-v-prestart-audit-pass`, `integration-services-healthy`, `audit-vm-state-restored`, and `hyper-v-audit-pass`; the fixed installed name remains absent and the VM returned to `Off`.

## Append-Only v67 Physical Timeout and Causal Repair Addendum

- The sole v67 physical run durably recorded prompt-ready SHA-256 `8b15603921b8107e8ad3025c9070b016ea7c780bbe89d4018b1a432e73529b2f` and accepted SHA-256 `5ac9e02117896efe55f6032af51a4291b27ce79066e05d2a30327c70a55bcfba` before entering the `reboot-pending` guest-runner stage.
- The bounded outer deadline then produced immutable blocker `C:\Users\Liiiraa\VM-Lab\Evidence\phase6\20260816-221445-clean-vm-BLOCKED.json`, SHA-256 `d7114726d3f4c14c4627d59e792323a87a4436e58b9761f414a93579ca115790`, with exact reason `BLOCKED:guest-runner-total-deadline`. v67 is terminal and will not be retried.
- Cleanup-only evidence `C:\Users\Liiiraa\VM-Lab\Evidence\20260816-221556-phase6observationcleanup-console.log`, SHA-256 `08a112e23bd09ef83449318a8672c061bed4627fb1797b0c035444b5fa7f77c3`, proves VM `Off`; checkpoint GUID `84b8d3b0-90d0-4850-8806-f373a28a38e9` and all evidence remain preserved.
- Read-only bounded diagnosis found no continuation, no raw envelope, no active requested scheme, and no surviving runner/WebDriver processes. Its safe projection is `C:\Users\Liiiraa\VM-Lab\Evidence\phase6\20260816-221915-820-managed-power-scheme-v67-timeout-diagnostic.safe.json`, `563` bytes, SHA-256 `185f890c1921e4c2f2fff5f2e7f4212f883539535645db7764fc61f25dea5d5e`.
- Causal TDD RED `b2bdc31e` and GREEN `b9aad639` add an atomic, write-through, allowlisted inner finite-state heartbeat and bounded timeout ingestion without raw output. Full gates passed: desktop Rust 251/251, Hyper-V 33/33, architecture 51/51, evidence 103/103, PowerShell parser PASS, and planned evaluator `ok: true`.

## Append-Only v68 Bridge and Read-Only Audit Addendum

- Bridge RED `b7348063` and GREEN `8f42c293` bind only build `physical-9f82fde77bf2940f-managed-power-scheme-v68`, artifact manifest SHA-256 `64f1cecd68757befba141cf3ff5179f6c6f693a9a1f6c29d9a9df9b094c25c9c`, deterministic run SHA-256 `20b8feea9edb5d64fa26b04fa235f5ea2115b038df5e17381d078b5a859172ce`, and evidence manifest SHA-256 `f4af847c37850010c0f3c4b024d2533a4e69efee2b837e4f579b478e2a3c0b9b`.
- The v67 installed checkpoint was archived rename-only as `LiiiraaBoost-Installed-BLOCKED-v67`, preserving GUID `84b8d3b0-90d0-4850-8806-f373a28a38e9`, VM `Off`, and checkpoint count 8→8. Durable evidence `C:\Users\Liiiraa\VM-Lab\Evidence\phase6\20260816-224120-142-managed-power-scheme-v67-checkpoint-archive.json` has SHA-256 `4bb670f0b83be43adcf56ab779abad69af4f4e4c652224219b7d1791b769099b`.
- Read-only Audit PASS: `C:\Users\Liiiraa\VM-Lab\Evidence\20260816-224155-phase6observedaudit-console.log`, SHA-256 `2360d1ce02b17503e9f438f29058cdb601c09194b1a09bfc42a7e25ff80bb0ed`.
- Audit proved six healthy integration services, exact immutable v68 authority, fixed installed checkpoint absent, and VM `Off` after observation. No artifact staging, restore, checkpoint creation, or guest mutation occurred.

## Append-Only v68 Physical Timeout and Pipe-EOF Repair Addendum

- The sole v68 physical run durably recorded prompt-ready SHA-256 `68967a7ed08d437fac15b5a8f3c3433722f21e57c22e9f479f377a792d7beb5e` and accepted-before-mutation SHA-256 `8f3f836c1b425bc28df9055ec2be51befb18591da079b1d17084214dcdab1dec`, then entered the bounded `reboot-pending` runner stage.
- Immutable blocker `C:\Users\Liiiraa\VM-Lab\Evidence\phase6\20260816-225812-clean-vm-BLOCKED.json`, `2364` bytes, SHA-256 `e7b6c94fbec21f3e51dd7e7cfa589c33448b788ddd8d98551e57a3f606a2661f`, records exact reason `BLOCKED:guest-runner-total-deadline`. Its raw-free heartbeat localizes the wait to `webdriver-launch` at `2026-08-17T01:45:11Z`, sidecar SHA-256 `3493dd69fd5f1f6ed3d9832fd59106fd1171ffa83c87149e8b4e608610d6098f`, `302` bytes. v68 is terminal and will not be retried.
- Transcript `C:\Users\Liiiraa\VM-Lab\Evidence\20260816-224314-phase6runcleanvm-console.log`, SHA-256 `cbd48bed31f1da9a014eb0769a051bb82bea5f0f36c765ca677013168c27bf72`, and cleanup-only evidence `C:\Users\Liiiraa\VM-Lab\Evidence\20260816-225904-phase6observationcleanup-console.log`, SHA-256 `08a112e23bd09ef83449318a8672c061bed4627fb1797b0c035444b5fa7f77c3`, prove the VM returned to `Off`; installed checkpoint GUID `84635905-a816-4b4e-9cdd-acb05b3c1dbf` and every evidence byte remain preserved.
- Causal TDD RED `273ff42c` and GREEN `96882498` prove that a native descendant can inherit the exited WebDriver parent's pipe and keep an EOF-based `read_to_end` blocked. Windows capture now uses `PeekNamedPipe`, reads only immediately available bytes under the existing 16 KiB cap, distinguishes clean pipe closure, never persists raw output, and closes owned handles on return. Full gates passed: desktop Rust 255/255, Hyper-V 33/33, architecture 51/51, evidence 103/103, PowerShell parser PASS, and planned evaluator `ok: true`.
