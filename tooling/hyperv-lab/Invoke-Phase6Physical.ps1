...
$CurrentAuthority = [pscustomobject][ordered]@{
    ...
    SourceCommit = 'f5d161f2d4acca90ed836f7a4ccccab6f514adea'
    ArtifactManifestSha256 = '64f1cecd68757befba141cf3ff5179f6c6f693a9a1f6c29d9a9df9b094c25c9c'
    SimulationRunId = 'phase6-deterministic-simulation-managed-power-scheme-v68-64f1cecd6875'
    SimulationRunSha256 = '20b8feea9edb5d64fa26b04fa235f5ea2115b038df5e17381d078b5a859172ce'
    ...
    GuestRoot = 'C:\LiiiraaBoost\Phase6\physical-9f82fde77bf2940f-managed-power-scheme-v68'
    GuestRunner = 'C:\LiiiraaBoost\Phase6\physical-9f82fde77bf2940f-managed-power-scheme-v68\phase6-physical-runner.exe'
    GuestConfig = 'C:\LiiiraaBoost\Phase6\physical-9f82fde77bf2940f-managed-power-scheme-v68\configs\clean-windows-vm.run-config.json'
}
...
$ExpectedTerminalTimeoutPredecessorOperationVersion = 'managed-power-scheme-v67'
$ExpectedTerminalTimeoutPredecessorBuildId = 'physical-7304c595be0d094e-managed-power-scheme-v67'
$ExpectedTerminalTimeoutPredecessorArtifactManifestSha256 = 'e2689db3ef625a3ef4b1d1bd3f7ad22278a0dc868d0eaedebd053fb0fc55984f'
$ExpectedTerminalTimeoutPredecessorRunId = 'phase6-deterministic-simulation-managed-power-scheme-v67-e2689db3ef62'
$ExpectedTerminalTimeoutPredecessorRunSha256 = '7e93a708b039cb5caaa8a4417ac6fe59189a274eb179afe75a3700995b481ce0'
$ExpectedTerminalTimeoutPredecessorManifestSha256 = 'bfa8ddc06bab183857e653b1f44b0106c0e4707bc7e74a3752e89277340f92f4'
$ExpectedTerminalTimeoutPredecessorManifestRelativePath = 'tooling/phase6-evidence/records/superseded/managed-power-scheme-v67-evidence-manifest.json'
$ExpectedBoundedHangPredecessorOperationVersion = 'managed-power-scheme-v66'
$ExpectedBoundedHangPredecessorBuildId = 'physical-7304c595be0d094e-managed-power-scheme-v66'
$ExpectedBoundedHangPredecessorArtifactManifestSha256 = 'f5093c1e464ea8dd563197283a2bdb7cfac4c68f7f30d398f5e3d5dc76137f4f'
$ExpectedBoundedHangPredecessorRunId = 'phase6-deterministic-simulation-managed-power-scheme-v66-f5093c1e464e'
$ExpectedBoundedHangPredecessorRunSha256 = 'faefe1cdfae5f546982ac31cdae3a627150d6a755e4de9d9b8a7fb1dd299bc64'
$ExpectedBoundedHangPredecessorManifestSha256 = 'd76fb46767e525647df47f2c03efc8cefe42dec5a20832b554e98d72d96f6584'
$ExpectedBoundedHangPredecessorManifestRelativePath = 'tooling/phase6-evidence/records/superseded/managed-power-scheme-v66-evidence-manifest.json'
$ExpectedBlockedActivePredecessorOperationVersion = 'managed-power-scheme-v65'
$ExpectedBlockedActivePredecessorBuildId = 'physical-7304c595be0d094e-managed-power-scheme-v65'
$ExpectedBlockedActivePredecessorArtifactManifestSha256 = 'd1001ae367af98ab67ac022d0170dc1bbed8c351eb998a087ef2f06a016af7f0'
$ExpectedBlockedActivePredecessorRunId = 'phase6-deterministic-simulation-managed-power-scheme-v65-d1001ae367af'
$ExpectedBlockedActivePredecessorRunSha256 = '0aa34013eb5d3314ba31daa9382f439442d7c85df3337230c648e8190689a649'
$ExpectedBlockedActivePredecessorManifestSha256 = '788f6b5392365829659c008755c909903d50f99179f934d59e4fa12937f4432a'
$ExpectedBlockedActivePredecessorManifestRelativePath = 'tooling/phase6-evidence/records/superseded/managed-power-scheme-v65-evidence-manifest.json'
$ExpectedSupersededActivePredecessorOperationVersion = 'managed-power-scheme-v58'
$ExpectedSupersededActivePredecessorBuildId = 'physical-9f5464923978c943-managed-power-scheme-v58'
$ExpectedSupersededActivePredecessorArtifactManifestSha256 = '2f407cc28495c09fdc8513c4dfd670749ba7b429d6133713af384f603e8aa888'
$ExpectedSupersededActivePredecessorRunId = 'phase6-deterministic-simulation-managed-power-scheme-v58-2f407cc28495'
$ExpectedSupersededActivePredecessorRunSha256 = 'ee3f5275a39982715f5e38a731ed9a1617de9163f05963e68a0a5a23c1ff0e5f'
$ExpectedSupersededActivePredecessorManifestSha256 = 'c74c3dd1bbe10949597fa938f4330856f6e6b3e18515468bf8ee4c84c772d90e'
$ExpectedSupersededActivePredecessorManifestRelativePath = 'tooling/phase6-evidence/records/superseded/managed-power-scheme-v58-evidence-manifest.json'
...
function Get-Authority {
    ...
    foreach ($required in @(
        ...
        $ExpectedTerminalTimeoutPredecessorOperationVersion,
        $ExpectedTerminalTimeoutPredecessorRunSha256,
        $ExpectedTerminalTimeoutPredecessorManifestSha256,
        $ExpectedBoundedHangPredecessorOperationVersion,
        $ExpectedBoundedHangPredecessorRunSha256,
        $ExpectedBoundedHangPredecessorManifestSha256,
        $ExpectedBlockedActivePredecessorOperationVersion,
        $ExpectedBlockedActivePredecessorRunSha256,
        $ExpectedBlockedActivePredecessorManifestSha256,
        $ExpectedSupersededActivePredecessorOperationVersion,
        $ExpectedSupersededActivePredecessorRunSha256,
        $ExpectedSupersededActivePredecessorManifestSha256,
    ...
    if ($admissions.Count -ne 19 -or @($admissions | Where-Object { $_.status -eq 'active' }).Count -ne 1) {
        throw 'BLOCKED: deterministic admission chain must contain eighteen predecessors and one active successor.'
    }
    ...
    $supersededActivePredecessor = $admissions[14]
    $blockedActivePredecessor = $admissions[15]
    $boundedHangPredecessor = $admissions[16]
    $terminalTimeoutPredecessor = $admissions[17]
    $active = $admissions[18]
    ...
    if ($newestActivePredecessor.status -ne 'superseded' -or
        ...
        $newestActivePredecessor.successorEvidenceSha256 -ne $ExpectedSupersededActivePredecessorRunSha256 -or
    ...
    if ($supersededActivePredecessor.status -ne 'superseded' -or
        $supersededActivePredecessor.operationVersion -ne $ExpectedSupersededActivePredecessorOperationVersion -or
        $supersededActivePredecessor.buildId -ne $ExpectedSupersededActivePredecessorBuildId -or
        $supersededActivePredecessor.artifactManifestSha256 -ne $ExpectedSupersededActivePredecessorArtifactManifestSha256 -or
        $supersededActivePredecessor.runEvidenceId -ne $ExpectedSupersededActivePredecessorRunId -or
        $supersededActivePredecessor.runEvidenceSha256 -ne $ExpectedSupersededActivePredecessorRunSha256 -or
        $supersededActivePredecessor.predecessorEvidenceSha256 -ne $ExpectedNewestActivePredecessorRunSha256 -or
        $supersededActivePredecessor.successorEvidenceSha256 -ne $ExpectedBlockedActivePredecessorRunSha256 -or
        $supersededActivePredecessor.manifestRecord.path -ne $ExpectedSupersededActivePredecessorManifestRelativePath -or
        $supersededActivePredecessor.manifestRecord.sha256 -ne $ExpectedSupersededActivePredecessorManifestSha256) {
        throw 'BLOCKED: physically BLOCKED v58 predecessor identity is invalid or reactivated.'
    }
    if ($blockedActivePredecessor.status -ne 'superseded' -or
        $blockedActivePredecessor.operationVersion -ne $ExpectedBlockedActivePredecessorOperationVersion -or
        $blockedActivePredecessor.buildId -ne $ExpectedBlockedActivePredecessorBuildId -or
        $blockedActivePredecessor.artifactManifestSha256 -ne $ExpectedBlockedActivePredecessorArtifactManifestSha256 -or
        $blockedActivePredecessor.runEvidenceId -ne $ExpectedBlockedActivePredecessorRunId -or
        $blockedActivePredecessor.runEvidenceSha256 -ne $ExpectedBlockedActivePredecessorRunSha256 -or
        $blockedActivePredecessor.predecessorEvidenceSha256 -ne $ExpectedSupersededActivePredecessorRunSha256 -or
        $blockedActivePredecessor.successorEvidenceSha256 -ne $ExpectedBoundedHangPredecessorRunSha256 -or
        $blockedActivePredecessor.manifestRecord.path -ne $ExpectedBlockedActivePredecessorManifestRelativePath -or
        $blockedActivePredecessor.manifestRecord.sha256 -ne $ExpectedBlockedActivePredecessorManifestSha256) {
        throw 'BLOCKED: physically BLOCKED v65 predecessor identity is invalid or reactivated.'
    }
    if ($boundedHangPredecessor.status -ne 'superseded' -or
        $boundedHangPredecessor.operationVersion -ne $ExpectedBoundedHangPredecessorOperationVersion -or
        $boundedHangPredecessor.buildId -ne $ExpectedBoundedHangPredecessorBuildId -or
        $boundedHangPredecessor.artifactManifestSha256 -ne $ExpectedBoundedHangPredecessorArtifactManifestSha256 -or
        $boundedHangPredecessor.runEvidenceId -ne $ExpectedBoundedHangPredecessorRunId -or
        $boundedHangPredecessor.runEvidenceSha256 -ne $ExpectedBoundedHangPredecessorRunSha256 -or
        $boundedHangPredecessor.predecessorEvidenceSha256 -ne $ExpectedBlockedActivePredecessorRunSha256 -or
        $boundedHangPredecessor.successorEvidenceSha256 -ne $ExpectedTerminalTimeoutPredecessorRunSha256 -or
        $boundedHangPredecessor.manifestRecord.path -ne $ExpectedBoundedHangPredecessorManifestRelativePath -or
        $boundedHangPredecessor.manifestRecord.sha256 -ne $ExpectedBoundedHangPredecessorManifestSha256) {
        throw 'BLOCKED: bounded-hang v66 predecessor identity is invalid or reactivated.'
    }
    if ($terminalTimeoutPredecessor.status -ne 'superseded' -or
        $terminalTimeoutPredecessor.operationVersion -ne $ExpectedTerminalTimeoutPredecessorOperationVersion -or
        $terminalTimeoutPredecessor.buildId -ne $ExpectedTerminalTimeoutPredecessorBuildId -or
        $terminalTimeoutPredecessor.artifactManifestSha256 -ne $ExpectedTerminalTimeoutPredecessorArtifactManifestSha256 -or
        $terminalTimeoutPredecessor.runEvidenceId -ne $ExpectedTerminalTimeoutPredecessorRunId -or
        $terminalTimeoutPredecessor.runEvidenceSha256 -ne $ExpectedTerminalTimeoutPredecessorRunSha256 -or
        $terminalTimeoutPredecessor.predecessorEvidenceSha256 -ne $ExpectedBoundedHangPredecessorRunSha256 -or
        $terminalTimeoutPredecessor.successorEvidenceSha256 -ne $ExpectedSimulationRunSha256 -or
        $terminalTimeoutPredecessor.manifestRecord.path -ne $ExpectedTerminalTimeoutPredecessorManifestRelativePath -or
        $terminalTimeoutPredecessor.manifestRecord.sha256 -ne $ExpectedTerminalTimeoutPredecessorManifestSha256) {
        throw 'BLOCKED: terminal-timeout v67 predecessor identity is invalid or reactivated.'
    }
    if ($active.status -ne 'active' -or
        ...
        $active.predecessorEvidenceSha256 -ne $ExpectedTerminalTimeoutPredecessorRunSha256 -or
        $null -ne $active.successorEvidenceSha256 -or
        $null -ne $active.manifestRecord) {
        throw 'BLOCKED: active v68 deterministic admission tuple/hash/link mismatch.'
    }
    ...
    $supersededActivePredecessorManifest = Join-Path $RepositoryRoot $ExpectedSupersededActivePredecessorManifestRelativePath.Replace('/', '\')
    if (-not (Test-Path -LiteralPath $supersededActivePredecessorManifest -PathType Leaf) -or
        (Get-FileSha256Hex -Path $supersededActivePredecessorManifest) -ne $ExpectedSupersededActivePredecessorManifestSha256) {
        throw 'BLOCKED: immutable v58 predecessor record is missing or changed.'
    }
    $supersededActivePredecessorDocument = [IO.File]::ReadAllText($supersededActivePredecessorManifest) | ConvertFrom-Json
    $supersededActivePredecessorStage = @($supersededActivePredecessorDocument.stages | Where-Object { $_.stage -eq 'deterministic-simulation' })
    $supersededActivePredecessorAdmissions = @($supersededActivePredecessorDocument.deterministicAdmissions)
    if ($supersededActivePredecessorDocument.schemaVersion -ne 3 -or
        $supersededActivePredecessorDocument.operationVersion -ne $ExpectedSupersededActivePredecessorOperationVersion -or
        $supersededActivePredecessorDocument.immutableBuild.id -ne $ExpectedSupersededActivePredecessorBuildId -or
        $supersededActivePredecessorDocument.immutableBuild.artifactManifestSha256 -ne $ExpectedSupersededActivePredecessorArtifactManifestSha256 -or
        $supersededActivePredecessorAdmissions.Count -ne 15 -or
        $supersededActivePredecessorAdmissions[13].operationVersion -ne $ExpectedNewestActivePredecessorOperationVersion -or
        $supersededActivePredecessorAdmissions[13].status -ne 'superseded' -or
        $supersededActivePredecessorAdmissions[14].operationVersion -ne $ExpectedSupersededActivePredecessorOperationVersion -or
        $supersededActivePredecessorAdmissions[14].status -ne 'active' -or
        $supersededActivePredecessorAdmissions[14].predecessorEvidenceSha256 -ne $ExpectedNewestActivePredecessorRunSha256 -or
        $supersededActivePredecessorStage.Count -ne 1 -or
        @($supersededActivePredecessorStage[0].runs).Count -ne 1 -or
        $supersededActivePredecessorStage[0].runs[0].id -ne $ExpectedSupersededActivePredecessorRunId -or
        $supersededActivePredecessorStage[0].runs[0].predecessorRunEvidenceSha256 -ne $ExpectedNewestActivePredecessorRunSha256) {
        throw 'BLOCKED: immutable v58 predecessor record identity is invalid.'
    }
    $blockedActivePredecessorManifest = Join-Path $RepositoryRoot $ExpectedBlockedActivePredecessorManifestRelativePath.Replace('/', '\')
    if (-not (Test-Path -LiteralPath $blockedActivePredecessorManifest -PathType Leaf) -or
        (Get-FileSha256Hex -Path $blockedActivePredecessorManifest) -ne $ExpectedBlockedActivePredecessorManifestSha256) {
        throw 'BLOCKED: immutable v65 predecessor record is missing or changed.'
    }
    $blockedActivePredecessorDocument = [IO.File]::ReadAllText($blockedActivePredecessorManifest) | ConvertFrom-Json
    $blockedActivePredecessorStage = @($blockedActivePredecessorDocument.stages | Where-Object { $_.stage -eq 'deterministic-simulation' })
    $blockedActivePredecessorAdmissions = @($blockedActivePredecessorDocument.deterministicAdmissions)
    if ($blockedActivePredecessorDocument.schemaVersion -ne 3 -or
        $blockedActivePredecessorDocument.operationVersion -ne $ExpectedBlockedActivePredecessorOperationVersion -or
        $blockedActivePredecessorDocument.immutableBuild.id -ne $ExpectedBlockedActivePredecessorBuildId -or
        $blockedActivePredecessorDocument.immutableBuild.artifactManifestSha256 -ne $ExpectedBlockedActivePredecessorArtifactManifestSha256 -or
        $blockedActivePredecessorAdmissions.Count -ne 16 -or
        $blockedActivePredecessorAdmissions[14].operationVersion -ne $ExpectedSupersededActivePredecessorOperationVersion -or
        $blockedActivePredecessorAdmissions[14].status -ne 'superseded' -or
        $blockedActivePredecessorAdmissions[15].operationVersion -ne $ExpectedBlockedActivePredecessorOperationVersion -or
        $blockedActivePredecessorAdmissions[15].status -ne 'active' -or
        $blockedActivePredecessorAdmissions[15].predecessorEvidenceSha256 -ne $ExpectedSupersededActivePredecessorRunSha256 -or
        $blockedActivePredecessorStage.Count -ne 1 -or
        @($blockedActivePredecessorStage[0].runs).Count -ne 1 -or
        $blockedActivePredecessorStage[0].runs[0].id -ne $ExpectedBlockedActivePredecessorRunId -or
        $blockedActivePredecessorStage[0].runs[0].predecessorRunEvidenceSha256 -ne $ExpectedSupersededActivePredecessorRunSha256) {
        throw 'BLOCKED: immutable v65 predecessor record identity is invalid.'
    }
    $boundedHangPredecessorManifest = Join-Path $RepositoryRoot $ExpectedBoundedHangPredecessorManifestRelativePath.Replace('/', '\')
    if (-not (Test-Path -LiteralPath $boundedHangPredecessorManifest -PathType Leaf) -or
        (Get-FileSha256Hex -Path $boundedHangPredecessorManifest) -ne $ExpectedBoundedHangPredecessorManifestSha256) {
        throw 'BLOCKED: immutable v66 predecessor record is missing or changed.'
    }
    $boundedHangPredecessorDocument = [IO.File]::ReadAllText($boundedHangPredecessorManifest) | ConvertFrom-Json
    $boundedHangPredecessorStage = @($boundedHangPredecessorDocument.stages | Where-Object { $_.stage -eq 'deterministic-simulation' })
    $boundedHangPredecessorAdmissions = @($boundedHangPredecessorDocument.deterministicAdmissions)
    if ($boundedHangPredecessorDocument.schemaVersion -ne 3 -or
        $boundedHangPredecessorDocument.operationVersion -ne $ExpectedBoundedHangPredecessorOperationVersion -or
        $boundedHangPredecessorDocument.immutableBuild.id -ne $ExpectedBoundedHangPredecessorBuildId -or
        $boundedHangPredecessorDocument.immutableBuild.artifactManifestSha256 -ne $ExpectedBoundedHangPredecessorArtifactManifestSha256 -or
        $boundedHangPredecessorAdmissions.Count -ne 17 -or
        $boundedHangPredecessorAdmissions[15].operationVersion -ne $ExpectedBlockedActivePredecessorOperationVersion -or
        $boundedHangPredecessorAdmissions[15].status -ne 'superseded' -or
        $boundedHangPredecessorAdmissions[16].operationVersion -ne $ExpectedBoundedHangPredecessorOperationVersion -or
        $boundedHangPredecessorAdmissions[16].status -ne 'active' -or
        $boundedHangPredecessorAdmissions[16].predecessorEvidenceSha256 -ne $ExpectedBlockedActivePredecessorRunSha256 -or
        $boundedHangPredecessorStage.Count -ne 1 -or
        @($boundedHangPredecessorStage[0].runs).Count -ne 1 -or
        $boundedHangPredecessorStage[0].runs[0].id -ne $ExpectedBoundedHangPredecessorRunId -or
        $boundedHangPredecessorStage[0].runs[0].predecessorRunEvidenceSha256 -ne $ExpectedBlockedActivePredecessorRunSha256) {
        throw 'BLOCKED: immutable v66 predecessor record identity is invalid.'
    }
    $terminalTimeoutPredecessorManifest = Join-Path $RepositoryRoot $ExpectedTerminalTimeoutPredecessorManifestRelativePath.Replace('/', '\')
    if (-not (Test-Path -LiteralPath $terminalTimeoutPredecessorManifest -PathType Leaf) -or
        (Get-FileSha256Hex -Path $terminalTimeoutPredecessorManifest) -ne $ExpectedTerminalTimeoutPredecessorManifestSha256) {
        throw 'BLOCKED: immutable v67 predecessor record is missing or changed.'
    }
    $terminalTimeoutPredecessorDocument = [IO.File]::ReadAllText($terminalTimeoutPredecessorManifest) | ConvertFrom-Json
    $terminalTimeoutPredecessorStage = @($terminalTimeoutPredecessorDocument.stages | Where-Object { $_.stage -eq 'deterministic-simulation' })
    $terminalTimeoutPredecessorAdmissions = @($terminalTimeoutPredecessorDocument.deterministicAdmissions)
    if ($terminalTimeoutPredecessorDocument.schemaVersion -ne 3 -or
        $terminalTimeoutPredecessorDocument.operationVersion -ne $ExpectedTerminalTimeoutPredecessorOperationVersion -or
        $terminalTimeoutPredecessorDocument.immutableBuild.id -ne $ExpectedTerminalTimeoutPredecessorBuildId -or
        $terminalTimeoutPredecessorDocument.immutableBuild.artifactManifestSha256 -ne $ExpectedTerminalTimeoutPredecessorArtifactManifestSha256 -or
        $terminalTimeoutPredecessorAdmissions.Count -ne 18 -or
        $terminalTimeoutPredecessorAdmissions[16].operationVersion -ne $ExpectedBoundedHangPredecessorOperationVersion -or
        $terminalTimeoutPredecessorAdmissions[16].status -ne 'superseded' -or
        $terminalTimeoutPredecessorAdmissions[17].operationVersion -ne $ExpectedTerminalTimeoutPredecessorOperationVersion -or
        $terminalTimeoutPredecessorAdmissions[17].status -ne 'active' -or
        $terminalTimeoutPredecessorAdmissions[17].predecessorEvidenceSha256 -ne $ExpectedBoundedHangPredecessorRunSha256 -or
        $terminalTimeoutPredecessorStage.Count -ne 1 -or
        @($terminalTimeoutPredecessorStage[0].runs).Count -ne 1 -or
        $terminalTimeoutPredecessorStage[0].runs[0].id -ne $ExpectedTerminalTimeoutPredecessorRunId -or
        $terminalTimeoutPredecessorStage[0].runs[0].predecessorRunEvidenceSha256 -ne $ExpectedBoundedHangPredecessorRunSha256) {
        throw 'BLOCKED: immutable v67 predecessor record identity is invalid.'
    }
    ...
    if ($evidenceManifest.operationVersion -ne $ExpectedOperationVersion -or
        ...
        $deterministic[0].runs[0].predecessorRunEvidenceSha256 -ne $ExpectedTerminalTimeoutPredecessorRunSha256 -or
        ...
        throw 'BLOCKED: deterministic simulation admission is not the exact active v68 authority.'
    }
